...
섹션 타이틀·간격 등 레이아웃 규격은 `section-style-guide.md` 를 따른다.
...
| **Secondary** (Gold) | `#C9A77C` | 액센트 보더, 구분선, 키워드 강조 |
| **Background** (Ivory) | `#FAF8F3` | 앱 전체 배경, 로딩 화면 |
| **Surface** (White) | `#FFFFFF` | 카드 / `section-wrapper--white` 배경 |
| **Accent** (Beige) | `#E6D8C3` | 베이지 섹션 래퍼 배경, 그라데이션 끝단 |

보조로 자주 쓰는 것: 구분선 `#e0e0e0`, 타임라인 전용 카멜 `#B8956A`,
본문 텍스트 `#333` / `#666` / `#999` (진함 → 연함 순).
