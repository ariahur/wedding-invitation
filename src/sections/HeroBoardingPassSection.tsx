...
import HeroPassFlip from "../components/HeroPassFlip/HeroPassFlip";
        ...
        >
          <div className="boarding-pass">
            <div className="boarding-pass__top-title">
              <span className="top-title-icon material-symbols-outlined">
                travel
              </span>
            ...
            <div className="boarding-pass__main">
                ...
                <div className="main-top-left">
                  <div className="airline-info">
                    ...
                    <div className="airline-flight">
                      <span className="airline-flight-label">
                        {t.hero.flightLabel}
                      </span>
                      <span className="airline-flight-number">
                        {t.hero.flight}
                      </span>
                    </div>
                  </div>
              ...
              <div className="main-route">
                ...
                <div className="route-center">
                  <div className="route-icon material-symbols-outlined">
                    travel
                  </div>
                ...
                <div className="route-destination">
                  ...
                  {language === "ko" ? (
                    <div className="route-city-ko">
                      {t.hero.destination.cityKo}
                    </div>
                  ) : (
            ...
            <div className="boarding-pass__couple">
              <div className="couple-groom">
                <div className="couple-line">
                  {language === "ko" ? (
                    <>
                      {t.hero.groom.parents.father} ·{" "}
                      {t.hero.groom.parents.mother} 의{" "}
                      {t.hero.groom.relationship}{" "}
                      <strong>{t.hero.groom.name}</strong>
                    </>
                  ) : (
                    <>
                      <strong>{t.hero.groom.name}</strong>
                      ...
                      <span style={{ fontWeight: "normal" }}>
                        Eldest Son of {t.hero.groom.parents.father} &{" "}
                        {t.hero.groom.parents.mother}
                      </span>
                    </>
                  )}
                </div>
              ...
              <div className="couple-bride">
                <div className="couple-line">
                  {language === "ko" ? (
                    <>
                      {t.hero.bride.parents.father} ·{" "}
                      {t.hero.bride.parents.mother} 의{" "}
                      {t.hero.bride.relationship}{" "}
                      <strong>{t.hero.bride.name}</strong>
                    </>
                  ) : (
                    <>
                      <strong>{t.hero.bride.name}</strong>
                      <br />
                      <span style={{ fontWeight: "normal" }}>
                        Eldest Daughter of {t.hero.bride.parents.father} &{" "}
                        {t.hero.bride.parents.mother}
                      </span>
                    </>
                  )}
                </div>
            ...
            <div className="boarding-pass__details">
              <div className="detail-row">
                ...
                <div className="detail-item">
                  ...
                  <span className="detail-value">{t.hero.time}</span>
                </div>
              </div>
