  ...
  ko: {
    ...
    photoDrop: {
      ...
      open: {
        ...
        namePlaceholder: "홍길동",
        dropTitle: "사진·영상 고르기",
        dropHint: "사진과 영상을 한 번에 최대 {max}개까지 부칠 수 있어요",
        counter: "{count} / {max}개",
        removeLabel: "빼기",
        messageLabel: "한마디",
        messageOptional: "(선택)",
        messagePlaceholder: "사진·영상과 함께 전하고 싶은 말씀이 있다면 남겨주세요",
        submit: "수하물 부치기",
        submitting: "부치는 중... {done}/{total}개",
        needName: "성함을 입력해주세요",
        noFiles: "부치실 사진이나 영상을 먼저 골라주세요",
        tooMany: "한 번에 최대 {max}개까지 부칠 수 있어요",
        tooLarge: "너무 큰 파일은 제외했어요 (사진 20MB · 영상 200MB까지)",
        invalidType: "사진·영상 파일만 부칠 수 있어요",
        partial: "{done}개는 접수되었지만 {failed}개는 실패했어요. 남은 파일을 다시 부쳐주세요.",
  ...
  en: {
    ...
    photoDrop: {
      ...
      open: {
        ...
        dropTitle: "Choose photos & videos",
        dropHint: "Up to {max} photos or videos at a time",
        counter: "{count} / {max}",
        removeLabel: "Remove",
        messageLabel: "A note",
        messageOptional: "(optional)",
        messagePlaceholder: "Add a few words to go with your photos and videos",
        submit: "Drop off baggage",
        submitting: "Dropping off... {done}/{total}",
        needName: "Please enter your name",
        noFiles: "Please choose the photos or videos you'd like to send",
        tooMany: "You can send up to {max} files at a time",
        tooLarge: "Some files were too large and were skipped (photos 20MB, videos 200MB)",
        invalidType: "Only photo and video files can be dropped off",
