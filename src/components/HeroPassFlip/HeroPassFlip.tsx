          ...
          {ticket && (
            ...
            >
              {isAttending ? (
                ...
                <span className="hero-pass hero-pass--open">
                  <span className="hero-pass__label">{ticketText.absent.label}</span>
                  <span className="hero-pass__open-title" lang={language}>
                    {renderMultilineText(ticketText.absent.title.replace('{name}', ticket.name))}
                  </span>
                  <span className="hero-pass__barcode-text">{ticketText.absent.footer}</span>
                </span>
              )}
